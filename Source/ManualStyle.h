...
// (Pitch = vert emeraude, l'encre des tampons de controle).
...
namespace palette
{
    ...
    inline const juce::Colour spot     { 0xff44c493 };   // encre spot du Pitch (vert emeraude)
}
...
// Dessine les cadrans "symbole schematique" et le commutateur rotatif SNAP
